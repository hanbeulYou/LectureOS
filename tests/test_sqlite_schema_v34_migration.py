...
class SQLiteSchemaVersionThirtyFourTests(unittest.TestCase):
    ...
    def test_v34_remains_a_supported_version(self) -> None:
        self.assertIn(34, sqlite_lifecycle._SUPPORTED_SCHEMA_VERSIONS)
        self.assertLessEqual(34, SQLITE_SCHEMA_VERSION)
