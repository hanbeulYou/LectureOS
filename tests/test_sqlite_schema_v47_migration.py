...
V47_TABLES = {"lecture_analysis_input_admissions"}
...
class SQLiteSchemaVersionFortySevenTests(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_migrates_v46_to_v47_preserving_existing_rows(self) -> None:
    ...
    def test_direct_v45_to_v47_is_rejected(self) -> None:
    ...
    def test_repository_rejects_pre_v47_schema(self) -> None:
        create_legacy_database(self.database_path, 46)
        connection = open_sqlite_database(self.database_path)
        try:
