...
class SQLiteSchemaVersionFortyTests(unittest.TestCase):
    ...
    def test_v40_remains_a_supported_version(self) -> None:
        self.assertIn(40, sqlite_lifecycle._SUPPORTED_SCHEMA_VERSIONS)
        self.assertLessEqual(40, SQLITE_SCHEMA_VERSION)
