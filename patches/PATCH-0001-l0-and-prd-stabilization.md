...
- [ ] docs/001_PRODUCT.md에서 Text Pipeline과 Edit Pipeline의 동등한 지위가 명시됨
- [ ] docs/001_PRODUCT.md에서 컷편집용 라벨링이 핵심 제품 책임으로 명시됨
- [ ] docs/002_FAQ.md에서 자동 컷편집과 Edit Candidate가 구분됨
- [ ] docs/002_FAQ.md에서 현재와 목표 워크플로가 구분됨
- [ ] docs/020_PRODUCT_REQUIREMENTS.md가 자막과 편집 분석 요구사항을 동등하게 다룸
- [ ] Edit Pipeline의 필수 구간 라벨이 정의됨
- [ ] Edit Candidate의 필수 정보가 요구사항에 포함됨
- [ ] Review의 Accept·Reject·Modify가 포함됨
- [ ] 사용자 결정 보존이 Must 요구사항으로 포함됨
- [ ] LectureOS와 Final Cut의 책임 경계가 명확함
- [ ] 필수 출력이 모두 정의됨
- [ ] local-first와 50% 목표의 상태가 명확함
- [ ] L0 철학과 제품 범위를 변경하지 않음
- [ ] 새 아키텍처 개념을 추가하지 않음
- [ ] git diff --check를 통과함
...
- [ ] Patch approved by Product Owner
